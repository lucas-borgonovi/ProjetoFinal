    ...
    public partial class CoorganicasContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                // optionsBuilder.UseSqlServer("Server=ALEFWHITE\\SQLEXPRESS; Database=Coorganicas; User Id=sa; Password=root");
                optionsBuilder.UseSqlServer("Server=DESKTOP-S0KNEVG\\SQLEXPRESS;Database=Coorganicas; User Id=sa; Password=132");
            }
        }
